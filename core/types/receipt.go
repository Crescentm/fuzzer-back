...
//func newpcpath() *PcPath {
//	return &PcPath{Path: make([]int, 0, 1024), Funcselect: make([]byte, 0, 1024)}
//}
//
//var GlobalPcPath *PcPath = newpcpath()
...
type Receipt struct {
	...
	TestFlag         []int       `json:"testValue"`
	TestPath         PcPath      `json:"pcpath"`
	TestCost         PcCost      `json:"pccost"`
}
